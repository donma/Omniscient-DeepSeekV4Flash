# Building Materials - AI Complete Website Generation Prompt
...
- **Brand Name:** Building Materials
- **Industry:** 空間生活
- **Positioning:** 適合建材品牌的產品型錄網站，展示材質與施工案例。
- **Visual Theme:** 灰白建築大圖材質
- **Layout Type:** 材質紋理
...
- **Hero Heading:** 構築您的理想空間
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Building Materials
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Building Materials
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Building Materials. All Rights Reserved.
