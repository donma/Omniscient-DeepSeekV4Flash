# Creative Agency - AI Complete Website Generation Prompt
...
- **Industry:** 設計服務
- **Positioning:** 為設計公司、品牌顧問打造的幾何現代品牌形象網站。
- **Visual Theme:** 幾何現代
...
- **Brand Text:** Creative Agency
- **Nav Items:** ABOUT, SERVICES, WORKS, REVIEWS, FAQ, CONTACT, BLOG
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** WE CREATE  BRANDS  THAT STAND OUT
- **Total Content Sections:** 3

  Section 1: [CREATIVE AGENCY] 
  Section 2: [WHAT WE DO] 我們的服務
  Section 3: [FEATURED] 精選作品

- **Footer Columns:** NOVA CREATIVE, LINKS, CONTACT, FOLLOW
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Creative Agency. All Rights Reserved.
