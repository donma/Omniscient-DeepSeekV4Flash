# Woodwork Studio - AI Complete Website Generation Prompt
...
- **Brand Name:** Woodwork Studio
- **Industry:** 空間
- **Positioning:** Woodwork Studio - 專為空間生活產業設計的全功能網站樣板。採用Storytelling 長卷軸版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #3a2a1a, #5a3a1a, #8a5a2a, #b88a4a, #e0d0b8
...
- **Brand Text:** Woodwork Studio
- **Nav Items:** 首頁, 關於, Works, Gallery, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 木頭的呼吸,職人的手
- **Total Content Sections:** 5

  Section 1: 關於 Woodwork Studio
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Woodwork Studio
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Woodwork Studio. All Rights Reserved.
