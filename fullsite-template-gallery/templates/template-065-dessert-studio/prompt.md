# Dessert Studio - AI Complete Website Generation Prompt
...
- **Brand Name:** Dessert Studio
- **Industry:** 餐飲
- **Positioning:** Dessert Studio - 專為餐飲甜點產業設計的全功能網站樣板。採用Masonry 作品牆版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #faf0f0, #f5e0e0, #e8b0b0, #d48080, #a05050
- **Layout Type:** Masonry 作品牆
...
- **Brand Text:** Dessert Studio
- **Nav Items:** 首頁, 關於, Cakes, Creations, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 甜蜜時光,幸福滋味
- **Total Content Sections:** 5

  Section 1: 關於 Dessert Studio
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Dessert Studio
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Dessert Studio. All Rights Reserved.
