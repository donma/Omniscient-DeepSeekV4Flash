# Tea Experience - AI Complete Website Generation Prompt
...
- **Brand Name:** Tea Experience
- **Industry:** 地方
- **Positioning:** Tea Experience - 專為地方品牌產業設計的全功能網站樣板。採用活動 / 體驗導向版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #2a3a2a, #4a5a3a, #7a8a5a, #c4b8a0, #f0ece0
- **Layout Type:** 活動 / 體驗導向
...
- **Brand Text:** Tea Experience
- **Nav Items:** 首頁, 關於, Experiences, Gallery, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 一盞茶,一世界
- **Total Content Sections:** 5

  Section 1: 關於 Tea Experience
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Tea Experience
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Tea Experience. All Rights Reserved.
