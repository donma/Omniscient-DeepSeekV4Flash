# Japanese Restaurant - AI Complete Website Generation Prompt
...
- **Brand Name:** Japanese Restaurant
- **Industry:** 餐飲
- **Positioning:** Japanese Restaurant - 專為餐飲甜點產業設計的全功能網站樣板。採用Storytelling 長卷軸版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #1a1a1a, #3a2a1a, #6b4a2a, #c4a88a, #f0ece0
- **Layout Type:** Storytelling 長卷軸
...
- **Brand Text:** Japanese Restaurant
- **Nav Items:** 首頁, 關於, Menu, Story, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 極致匠心,一期一會
- **Total Content Sections:** 5

  Section 1: 關於 Japanese Restaurant
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Japanese Restaurant
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Japanese Restaurant. All Rights Reserved.
