# HR Consulting - AI Complete Website Generation Prompt
...
- **Brand Name:** HR Consulting
- **Industry:** 專業服務
- **Positioning:** 適合人資顧問公司的專業服務網站。
- **Visual Theme:** 淺色商務人像感
- **Layout Type:** 團隊人像
...
- **Hero Heading:** 發掘人才，成就企業
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 HR Consulting
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** HR Consulting
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 HR Consulting. All Rights Reserved.
