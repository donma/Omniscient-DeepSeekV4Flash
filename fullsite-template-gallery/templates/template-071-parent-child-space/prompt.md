# Parent Child Space - AI Complete Website Generation Prompt
...
- **Brand Name:** Parent Child Space
- **Industry:** 教育
- **Positioning:** Parent Child Space - 專為教育課程產業設計的全功能網站樣板。採用活動 / 體驗導向版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #fce4ec, #f8bbd0, #c8e6c9, #81c784, #ffcc02
- **Layout Type:** 活動 / 體驗導向
...
- **Brand Text:** Parent Child Space
- **Nav Items:** 首頁, 關於, Activities, Gallery, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 陪伴,是最好的成長
- **Total Content Sections:** 5

  Section 1: 關於 Parent Child Space
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Parent Child Space
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Parent Child Space. All Rights Reserved.
