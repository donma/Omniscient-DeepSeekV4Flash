# Podcast Show - AI Complete Website Generation Prompt
...
- **Brand Name:** Podcast Show
- **Industry:** 個人品牌
- **Positioning:** 適合 Podcast 節目的品牌官網，展示集數與訂閱資訊。
- **Visual Theme:** 深色聲波媒體感
- **Layout Type:** 聲波動畫
...
- **Hero Heading:** 聽見不一樣的聲音
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Podcast Show
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Podcast Show
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Podcast Show. All Rights Reserved.
