# Cooking Class - AI Complete Website Generation Prompt
...
- **Brand Name:** Cooking Class
- **Industry:** 教育
- **Positioning:** Cooking Class - 專為教育課程產業設計的全功能網站樣板。採用活動 / 體驗導向版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #faf6f0, #f0e8dc, #e8c49a, #c9863a, #6a3a1a
- **Layout Type:** 活動 / 體驗導向
...
- **Brand Text:** Cooking Class
- **Nav Items:** 首頁, 關於, Classes, Menu, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 料理,是愛的語言
- **Total Content Sections:** 5

  Section 1: 關於 Cooking Class
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Cooking Class
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Cooking Class. All Rights Reserved.
