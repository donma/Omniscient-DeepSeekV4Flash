# Bar Lounge - AI Complete Website Generation Prompt
...
- **Brand Name:** Bar Lounge
- **Industry:** 餐飲
- **Positioning:** Bar Lounge - 專為餐飲甜點產業設計的全功能網站樣板。採用大圖沉浸式 Hero版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #0a0a0a, #1a1a1a, #c9a84c, #8a7a3a, #f5f0e0
