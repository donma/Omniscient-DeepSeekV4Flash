# Language School - AI Complete Website Generation Prompt
...
- **Brand Name:** Language School
- **Industry:** 教育學習
- **Positioning:** 為語言學校、補習班設計的活潑明亮形象網站。藍黃色調搭配圓角卡片，展現活力與學習熱情。
- **Visual Theme:** 明亮活潑藍黃
...
- **Footer Columns:** Global Language Center 全球語言中心, 快速連結, 聯絡資訊, 追蹤我們
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Language School. All Rights Reserved.
