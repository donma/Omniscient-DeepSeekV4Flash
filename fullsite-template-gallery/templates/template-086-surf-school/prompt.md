# Surf School - AI Complete Website Generation Prompt
...
- **Brand Name:** Surf School
- **Industry:** 旅遊
- **Positioning:** Surf School - 專為旅遊休閒產業設計的全功能網站樣板。採用大圖沉浸式 Hero版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #0a4a6a, #1a7aaa, #4ab5d9, #f5d06a, #f0f8fa
