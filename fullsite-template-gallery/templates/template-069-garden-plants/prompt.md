# Garden Plants - AI Complete Website Generation Prompt
...
- **Brand Name:** Garden Plants
- **Industry:** 空間
- **Positioning:** Garden Plants - 專為空間生活產業設計的全功能網站樣板。採用Masonry 作品牆版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #f0f5ea, #d4e0c0, #7a9a4a, #4a6a2a, #2a3a1a
...
- **Brand Text:** Garden Plants
- **Nav Items:** 首頁, 關於, Plants, Garden, 評價, FAQ, 部落格, 聯絡
...
- **Total Content Sections:** 5
  ...
  Section 1: 關於 Garden Plants
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Garden Plants
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Garden Plants. All Rights Reserved.
