# Furniture Brand - AI Complete Website Generation Prompt
...
- **Brand Name:** Furniture Brand
- **Industry:** 空間
- **Positioning:** Furniture Brand - 專為空間生活產業設計的全功能網站樣板。採用商品型 Grid Catalog版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #f5f5f0, #e0dcd4, #c4b8a0, #8a7a60, #4a3a2a
...
- **Brand Text:** Furniture Brand
- **Nav Items:** 首頁, 關於, Collections, Spaces, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 家的模樣,由你定義
- **Total Content Sections:** 5

  Section 1: 關於 Furniture Brand
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Furniture Brand
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Furniture Brand. All Rights Reserved.
