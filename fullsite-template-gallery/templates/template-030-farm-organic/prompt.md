# Farm Organic - AI Complete Website Generation Prompt
...
- **Brand Name:** Farm Organic
- **Industry:** 餐飲美食
- **Positioning:** 為有機農場、小農品牌設計的綠色大地風格網站。自然健康色調傳遞土地的力量。
- **Visual Theme:** 綠色大地自然健康
...
- **Footer Columns:** 綠色大地有機農場, 快速連結, 聯絡資訊, 追蹤我們
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Farm Organic. All Rights Reserved.
