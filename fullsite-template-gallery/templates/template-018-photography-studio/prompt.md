# Photography Studio - AI Complete Website Generation Prompt
...
- **Brand Name:** Photography Studio
- **Industry:** 生活美業
- **Positioning:** 為攝影工作室、攝影師打造的作品導向形象網站。黑白極簡突顯影像的純粹與力量。
- **Visual Theme:** 黑白大圖作品導向
...
- **Brand Text:** Photography Studio
- **Nav Items:** 關于, 方案, 服務介紹, 作品集, 好評, FAQ, 詢問檔期, 流程, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 捕捉  瞬間  成永恒
- **Total Content Sections:** 0


- **Footer Columns:** 光圈攝影工作室, 快速連結, 聯絡資訊, 追蹤我們
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Photography Studio. All Rights Reserved.
