# Author Book Site - AI Complete Website Generation Prompt
...
- **Brand Name:** Author Book Site
- **Industry:** 個人品牌
- **Positioning:** 適合作家的個人網站，介紹書籍與作者故事。
- **Visual Theme:** 紙感閱讀溫暖
- **Layout Type:** 書本翻頁
...
- **Hero Heading:** 用文字溫暖世界
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Author Book Site
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Author Book Site
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Author Book Site. All Rights Reserved.
