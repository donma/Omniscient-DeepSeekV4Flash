# Accounting Office - AI Complete Website Generation Prompt
...
- **Brand Name:** Accounting Office
- **Industry:** 專業服務
- **Positioning:** 為會計師事務所以及記賬士事務所設計的專業形象網站。白灰藍綠色調呈現理性、專業與可靠。
- **Visual Theme:** 白灰藍綠干凈理性
...
- **Footer Columns:** 誠信會計記賬士事務所, 快速連結, 聯絡資訊, 追蹤我們
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Accounting Office. All Rights Reserved.
