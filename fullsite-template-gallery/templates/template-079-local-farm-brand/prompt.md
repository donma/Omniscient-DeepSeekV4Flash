# Local Farm Brand - AI Complete Website Generation Prompt
...
- **Brand Name:** Local Farm Brand
- **Industry:** 地方
- **Positioning:** Local Farm Brand - 專為地方品牌產業設計的全功能網站樣板。採用Storytelling 長卷軸版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #2d4a2a, #4a6a3a, #7a9a5a, #c4d4a0, #f0f5ea
...
- **Brand Text:** Local Farm Brand
- **Nav Items:** 首頁, 關於, Products, Story, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 從土地到餐桌,純粹的承諾
- **Total Content Sections:** 5

  Section 1: 關於 Local Farm Brand
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Local Farm Brand
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Local Farm Brand. All Rights Reserved.
