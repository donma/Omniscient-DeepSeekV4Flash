# System Integrator - AI Complete Website Generation Prompt
...
- **Brand Name:** System Integrator
- **Industry:** 科技商務
- **Positioning:** 適合系統整合商的企業官網，展示技術整合能力。
- **Visual Theme:** 白灰藍企業感
- **Layout Type:** 流程圖
...
- **Hero Heading:** 串聯科技，驅動未來
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 System Integrator
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** System Integrator
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 System Integrator. All Rights Reserved.
