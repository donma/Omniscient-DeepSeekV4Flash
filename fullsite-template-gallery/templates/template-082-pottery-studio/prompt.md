# Pottery Studio - AI Complete Website Generation Prompt
...
- **Brand Name:** Pottery Studio
- **Industry:** 空間
- **Positioning:** Pottery Studio - 專為空間生活產業設計的全功能網站樣板。採用Masonry 作品牆版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #d4c4a0, #b8a480, #8a7a5a, #5a4a3a, #2a1a0a
...
- **Hero Heading:** 泥土中誕生的藝術
- **Total Content Sections:** 5

  Section 1: 關於 Pottery Studio
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Pottery Studio
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Pottery Studio. All Rights Reserved.
