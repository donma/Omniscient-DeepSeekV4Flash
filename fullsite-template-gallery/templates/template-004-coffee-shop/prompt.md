# Coffee Shop - AI Complete Website Generation Prompt
...
- **Industry:** 餐飲服務
- **Positioning:** 為咖啡廳、甜點店、烘焙坊打造的溫暖木質調形象網站。營造舒適放鬆的咖啡館氛圍。
- **Visual Theme:** 木質暖棕
...
- **Brand Text:** Coffee Shop
- **Nav Items:** 關於, Menu, 推薦, 藝廊, 好評, FAQ, 訂位, 理念, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** CAFE LUMIERE
- **Total Content Sections:** 5

  Section 1: [WHERE COFFEE MEETS ART] 
  Section 2: [OUR COFFEE] 我們的咖啡哲學
  Section 3: [SIGNATURE] 人氣飲品
  Section 4: [ATMOSPHERE] 城市中的寧靜角落
  Section 5: [ABOUT US] 我們的咖啡故事

- **Footer Columns:** CAFE LUMIERE, 快速連結, 營業資訊, 追蹤我們
