# Brunch Cafe - AI Complete Website Generation Prompt
...
- **Brand Name:** Brunch Cafe
- **Industry:** 餐飲
- **Positioning:** Brunch Cafe - 專為餐飲甜點產業設計的全功能網站樣板。採用左右分割 Split Hero版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #faf6f0, #f0e8dc, #e8d5c4, #c9a88e, #8c6e5d
- **Layout Type:** 左右分割 Split Hero
...
- **Hero Heading:** 早安,美好的一天
- **Total Content Sections:** 5

  Section 1: 關於 Brunch Cafe
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Brunch Cafe
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Brunch Cafe. All Rights Reserved.
