# Chinese Medicine - AI Complete Website Generation Prompt
...
- **Brand Name:** Chinese Medicine
- **Industry:** 美容健康
- **Positioning:** 適合中醫診所的傳統東方風格官網，傳遞養生理念。
- **Visual Theme:** 米白墨綠東方信任
- **Layout Type:** 東方風格
...
- **Hero Heading:** 傳承千年智慧，守護您的健康
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Chinese Medicine
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Chinese Medicine
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Chinese Medicine. All Rights Reserved.
