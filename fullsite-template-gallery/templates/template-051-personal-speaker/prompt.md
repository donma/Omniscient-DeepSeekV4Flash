# Personal Speaker - AI Complete Website Generation Prompt
...
- **Brand Name:** Personal Speaker
- **Industry:** 個人品牌
- **Positioning:** 適合專業講者的個人品牌官網，展示演講主題與經歷。
- **Visual Theme:** 深色高級舞臺感
- **Layout Type:** 舞臺聚光燈
...
- **Hero Heading:** 啟發思維，改變視野
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Personal Speaker
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Personal Speaker
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Personal Speaker. All Rights Reserved.
