# Event Planning - AI Complete Website Generation Prompt
...
- **Brand Name:** Event Planning
- **Industry:** 創意設計
- **Positioning:** 適合活動策劃公司的創意官網，展示精彩活動案例。
- **Visual Theme:** 高彩現代動態感
- **Layout Type:** 動態派對
...
- **Hero Heading:** 打造每一場難忘的盛典
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Event Planning
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Event Planning
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Event Planning. All Rights Reserved.
