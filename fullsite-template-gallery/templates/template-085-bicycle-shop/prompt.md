# Bicycle Shop - AI Complete Website Generation Prompt
...
- **Brand Name:** Bicycle Shop
- **Industry:** 零售
- **Positioning:** Bicycle Shop - 專為零售商品產業設計的全功能網站樣板。採用商品型 Grid Catalog版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #0a0a0a, #2a2a2a, #5a5a5a, #e87a20, #f5f5f5
