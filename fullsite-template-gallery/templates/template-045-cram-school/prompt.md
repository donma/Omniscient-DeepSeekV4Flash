# Cram School - AI Complete Website Generation Prompt
...
- **Brand Name:** Cram School
- **Industry:** 教育課程
- **Positioning:** 適合補習班的招生官網，展示課程與教學成果。
- **Visual Theme:** 明亮藍黃教育感
- **Layout Type:** 學生圖
...
- **Hero Heading:** 讓孩子愛上學習
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Cram School
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Cram School
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Cram School. All Rights Reserved.
