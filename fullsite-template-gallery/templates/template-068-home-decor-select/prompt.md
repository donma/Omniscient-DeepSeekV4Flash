# Home Decor Select - AI Complete Website Generation Prompt
...
- **Brand Name:** Home Decor Select
- **Industry:** 空間
- **Positioning:** Home Decor Select - 專為空間生活產業設計的全功能網站樣板。採用Magazine 雜誌式首頁版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #faf6f0, #f0e8dc, #d4c8b0, #a8987a, #6a5a4a
...
- **Brand Text:** Home Decor Select
- **Nav Items:** 首頁, 關於, Shop, Magazine, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 生活的美好,從家開始
- **Total Content Sections:** 5

  Section 1: 關於 Home Decor Select
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Home Decor Select
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Home Decor Select. All Rights Reserved.
