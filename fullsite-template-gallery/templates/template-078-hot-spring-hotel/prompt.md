# Hot Spring Hotel - AI Complete Website Generation Prompt
...
- **Brand Name:** Hot Spring Hotel
- **Industry:** 旅遊
- **Positioning:** Hot Spring Hotel - 專為旅遊休閒產業設計的全功能網站樣板。採用Storytelling 長卷軸版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #1a2a2a, #3a5a4a, #6a8a7a, #a0c0b0, #e8f0ea
...
- **Brand Text:** Hot Spring Hotel
- **Nav Items:** 首頁, 關於, Rooms, Onsen, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 沉浸在自然的懷抱
- **Total Content Sections:** 5

  Section 1: 關於 Hot Spring Hotel
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Hot Spring Hotel
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Hot Spring Hotel. All Rights Reserved.
