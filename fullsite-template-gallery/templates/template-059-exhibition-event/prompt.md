# Exhibition Event - AI Complete Website Generation Prompt
...
- **Brand Name:** Exhibition Event
- **Industry:** 活動組織
- **Positioning:** 適合展覽/藝廊的活動官網，白牆大圖凸顯藝術品。
- **Visual Theme:** 白色藝廊大圖
- **Layout Type:** 藝廊白牆
...
- **Hero Heading:** 藝術與空間的對話
- **Total Content Sections:** 5

  Section 1: 核心服務
  Section 2: 關於 Exhibition Event
  Section 3: 客戶好評
  Section 4: 最新消息
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Exhibition Event
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Exhibition Event. All Rights Reserved.
