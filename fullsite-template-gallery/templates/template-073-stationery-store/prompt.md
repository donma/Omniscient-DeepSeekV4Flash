# Stationery Store - AI Complete Website Generation Prompt
...
- **Brand Name:** Stationery Store
- **Industry:** 零售
- **Positioning:** Stationery Store - 專為零售商品產業設計的全功能網站樣板。採用Magazine 雜誌式首頁版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #faf8f5, #f0ece4, #d4c8b0, #8a7a5a, #4a3a2a
...
- **Brand Text:** Stationery Store
- **Nav Items:** 首頁, 關於, Products, Journal, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 書寫你的每一天
- **Total Content Sections:** 5

  Section 1: 關於 Stationery Store
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Stationery Store
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Stationery Store. All Rights Reserved.
