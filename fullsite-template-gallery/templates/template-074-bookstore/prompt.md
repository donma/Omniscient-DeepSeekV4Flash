# Bookstore - AI Complete Website Generation Prompt
...
- **Brand Name:** Bookstore
- **Industry:** 地方
- **Positioning:** Bookstore - 專為地方品牌產業設計的全功能網站樣板。採用Magazine 雜誌式首頁版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #f5f0e8, #e8e0d0, #c4b89a, #8a7a5a, #3a2a1a
