# Fitness Coach - AI Complete Website Generation Prompt
...
- **Brand Name:** Fitness Coach
- **Industry:** 運動健康
- **Positioning:** 為健身教練與運動工作室打造的高對比動態形象網站。
- **Visual Theme:** 深色高對比
...
- **Brand Text:** Fitness Coach
- **Nav Items:** ABOUT, TRAINING, PROGRAM, BEFORE/AFTER, REVIEWS, FAQ, BOOK, PROCESS, BLOG, CONTACT
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** FORGE YOUR  STRONGEST  SELF
- **Total Content Sections:** 4

  Section 1: [IRON FORGE FITNESS] 
  Section 2: [RESULTS] 用數字說話
  Section 3: [PROGRAMS] 訓練方案
  Section 4: [ABOUT] ABOUT YOUR COACH

- **Footer Columns:** IRON FORGE, LINKS, HOURS, FOLLOW
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Fitness Coach. All Rights Reserved.
