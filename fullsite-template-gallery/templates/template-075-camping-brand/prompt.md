# Camping Brand - AI Complete Website Generation Prompt
...
- **Brand Name:** Camping Brand
- **Industry:** 旅遊
- **Positioning:** Camping Brand - 專為旅遊休閒產業設計的全功能網站樣板。採用大圖沉浸式 Hero版型設計，打造專業的品牌形象網站。
- **Visual Theme:** #1a2a1a, #2a4a2a, #4a6a3a, #8a9a5a, #d4c8a0
...
- **Brand Text:** Camping Brand
- **Nav Items:** 首頁, 關於, Gear, Adventures, 評價, FAQ, 部落格, 聯絡
- Mobile: Hamburger toggle button with Bootstrap collapse
- Breakpoint: navbar-expand-lg

## 5. Homepage (index.html) Structure

- **Hero Heading:** 探索自然,挑戰自我
- **Total Content Sections:** 5

  Section 1: 關於 Camping Brand
  Section 2: 我們的服務
  Section 3: 為什麼選擇我們
  Section 4: 客戶評價
  Section 5: 準備好開始了嗎？

- **Footer Columns:** Camping Brand
- **Social Icons:** Facebook, Instagram, Line (Bootstrap Icons)
- **Copyright:** 2026 Camping Brand. All Rights Reserved.
